...
class testPlane {
	...
	/*
	    ...
	    public void testGetNormalPoint3D() {
	        ...
	        // TC01: There is a simple single test here  ------------> The test falls because of 0.000000000001
	    ...
	    public void testfindIntersectionsRay() {
	        ...
	        // ============ Equivalence Partitions Tests ==============
	        // TC01: Ray into plane ------------> The test falls because of [] from the list
	        assertEquals("Bad plane intersection",new Point3D(1, 0, 0),
	        ...
	        // TC13: Orthogonal ray into plane ------------> The test falls because of [] from the list
	        // and 0.000000000001
	        assertEquals("Bad plane intersection",  new Point3D(1d / 3, 1d / 3, 1d / 3),
